                                             ...
                                             <table class="table UserTable table-hover text-dark dataTable no-footer" id="DataTables_Table_0" role="grid" aria-describedby="DataTables_Table_0_info">
                                                  <thead>
                                                       <tr role="row">
                                                            ...
                                                            <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" style="width: 143.359px;" aria-label="Ref. level: activate to sort column ascending">Ref. level</th>
                                                            <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" style="width: 112.297px;" aria-label="Parent: activate to sort column ascending">Parent</th>
                                                            ...
                                                            <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" style="width: 213.547px;" aria-label="Date registered: activate to sort column ascending">Date registered</th>
                                                       </tr>
                                                  </thead>
                                                  <tbody>
