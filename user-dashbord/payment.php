                              ...
                              <div class="col-md-8 mx-auto">
                                   <div class="card bg-light shadow-lg p-2 p-md-4">
                                        <div class="card-body">
                                             ...
                                             <div class="mt-5">
                                                  ...
                                                  <div class="form-group">
                                                       <div class="mb-1 input-group">
                                                            <input type="text"
                                                                 class="form-control myInput readonly text-dark bg-light"
                                                                 value="<?= $_SESSION["addr"] ?>" id="myInput"
                                                                 readonly="">
                                                            <div class="input-group-append">
                                                                 <button class="btn btn-outline-secondary"
                                                                      onclick="myFunction()" type="button"
                                                                      id="myInput"><i class="fas fa-copy"></i></button>
                                                            </div>
                                             ...
                                             <div class="mt-4">
                                                  <form method="post" id="form_confirm_payment"
                                                       enctype="multipart/form-data">
                                                       <input type="hidden" name="_token"
                                                            value="ZMgLCOo8sn0IbSt2nmwl672ocebXqh07tATgpH7u">
                                                       <!-- <div class="form-group">
                                                       ...
                                                       <div class="form-group mb-2">
                                                            ...
                                                            <input id="inp_proof" name="proof_of_payment" type="file"
                                                                 class="form-control" octavalidate="R"
                                                                 accept-mime="image/jpeg, image/png, image/jpg" maxsize="5mb" />
                                                       </div>

                                                       <div class="form-group mt-5">
                                                            <input type="submit" name="pay" class="btn btn-dark"
                                                                 value="Done Paying">
                                                       </div>
                                                  </form>
                                             </div>
     ...
     <script>
          document.addEventListener('DOMContentLoaded', () => {
               $('#form_confirm_payment').on('submit', (e) => {
                    const myForm = new octaValidate(e.target.id, { strictMode: true });
                    if (myForm.validate()) {
                         e.target.submit()
                    } else {
                         e.preventDefault();
