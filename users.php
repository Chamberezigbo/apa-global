            ...
            <ul class="nav-menu list-unstyled d-flex flex-md-row align-items-md-center">
              ...
              <li class="nav-item dropdown"><a class="nav-link text-white dropdown-toggle d-flex align-items-center"
                ...
                <ul class="dropdown-menu dropdown-menu-end mt-3 shadow-sm" aria-labelledby="languages">
                  <li><a class="dropdown-item" rel="nofollow" href="#"> <img class="me-2" src="img/flags/16/DE.png"
                        alt="English"><span class="text-xs text-gray-700">German</span></a></li>
              ...
              <table class="table mb-0 table-striped table-hover">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="<?php print('./user?id='.$user['id']) ?>" class="btn btn-info">Profile</a>
                    </td>
                    <td>
                      <a href="<?php print('./transactions?id='.$user['id']) ?>" class="btn btn-info">Transactions</a>
                    </td>
                  </tr>
                <?php  } ?>
                </tbody>
