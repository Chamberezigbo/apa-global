                        ...
                        <div class="row">
                            ...
                            <div class="col-8 text-end">
                                ...
                                <form class="d-inline" method="post"
                                    onsubmit="return confirm('Are you sure that you want to deactivate this user?')">
                                ...
                                <?php else: ?>
                                <form class="d-inline" method="post"
                                    onsubmit="return confirm('Are you sure that you want to activate this user?')">
                                    <input type="hidden" name="id" value="<?php print($id); ?>" />
                ...
                <div class="modal-body">
                    <form method="post" id="form_upd_pass">
                        ...
                        <div class="mb-2">
                            ...
                            <input autocomplete="off" name="pass" id="inp_pass" type="password" class="form-control"
                                placeholder="Enter new password" octavalidate="R" />
                        </div>
                        <div class="mb-2">
                            <label>Confirm password</label>
                            <input autocomplete="off" id="inp_conpass" type="password" class="form-control"
                                placeholder="Re-enter password" equalto="inp_pass" octavalidate="R"
                                ov-equalto:msg="Both passwords do not match" />
                        </div>
                    </form>
                </div>
                ...
                <div class="modal-body">
                    <form method="post" id="form_upd_bal">
                        ...
                        <div class="mb-2">
                            ...
                            <input name="total_bonus" id="inp_t_bonus" type="number" class="form-control"
                                placeholder="Enter total bonus" octavalidate="R,DIGITS" value="<?php (isset($user['total_bonus'])) ? print($user['total_bonus']) : ''; ?>" />
                        </div>
                        <div class="mb-2">
                            <label>Total profit</label>
                            <input name="total_profit" id="inp_t_profit" type="number" class="form-control"
                                placeholder="Enter total profit" octavalidate="R,DIGITS" value="<?php (isset($user['total_profit'])) ? print($user['total_profit']) : ''; ?>" />
                        </div>
                        <div class="mb-2">
                            <label>Total deposit</label>
                            <input name="total_deposit" id="inp_t_deposit" type="number" class="form-control"
                                placeholder="Enter total deposit" octavalidate="R,DIGITS" value="<?php (isset($user['total_deposit'])) ? print($user['total_deposit']) : ''; ?>" />
                        </div>
                        <div class="mb-2">
                            <label>Total investment plans</label>
                            <input name="total_inv_plans" id="inp_inv_plans" type="number" class="form-control"
                                placeholder="Enter total investment plans" octavalidate="R,DIGITS" value="<?php (isset($user['total_inv_plans'])) ? print($user['total_inv_plans']) : ''; ?>" />
                        </div>
                        <div class="mb-2">
                            <label>Total active plans</label>
                            <input name="total_act_plans" id="inp_act_plans" type="number" class="form-control"
                                placeholder="Enter total active plans" octavalidate="R,DIGITS" value="<?php (isset($user['total_act_plans'])) ? print($user['total_act_plans']) : ''; ?>" />
                        </div>
                    </form>
                </div>
                <div class="modal-footer">
