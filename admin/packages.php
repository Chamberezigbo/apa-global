                ...
                foreach ($packages as $i => $package) {
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <button data-package-id="<?php echo $package['id']; ?>"
                                class="btn btn-success btn-upd-package  mb-2 mb-md-0">Update</button>
                            <form method="post"
                                onsubmit="return confirm('Are you sure that you want to delete this package?')" class="d-inline">
        ...
        <div style="max-width: 500px; margin:auto;">
            <form method="post" id="form_new_package" novalidate>
                <div class="mb-3">
                    ...
                    <input class="form-control" type="text" name="package_name" id="inp_package_name"
                        octavalidate="R,TEXT">
                </div>
                <div class="mb-3">
                    <label class="form-label">Minimum Deposit</label>
                    <input class="form-control" type="number" name="min_deposit" id="inp_min_deposit"
                        octavalidate="R,DIGITS">
                </div>
                <div class="mb-3">
                    <label class="form-label">Maximum Deposit</label>
                    <input class="form-control" type="number" name="max_deposit" id="inp_max_deposit"
                        octavalidate="R,DIGITS">
                </div>
                <div class="mb-3">
                    <label class="form-label">Minimum return</label>
                    <input class="form-control" type="number" name="min_return" id="inp_min_return"
                        octavalidate="R,DIGITS">
                </div>
                <div class="mb-3">
                    <label class="form-label">Maximum return</label>
                    <input class="form-control" type="number" name="max_return" id="inp_max_return"
                        octavalidate="R,DIGITS">
                </div>
                <div class="mb-3">
                    <label class="form-label">Gift Bonus</label>
                    <input class="form-control" type="number" name="bonus" id="inp_bonus" octavalidate="R,DIGITS"
                        value="0">
                </div>
                <div class="mb-3">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" id="form_upd_bal">
                        ...
                        <div class="mb-3">
                            <label class="form-label">Gift Bonus</label>
                            <input class="form-control" type="number" name="bonus" id="inp_bonus"
                                octavalidate="R,DIGITS" value="0">
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Duration</label>
                            <input class="form-control" type="text" name="duration" id="inp_duration"
                                octavalidate="R,TEXT">
                        </div>
                    </form>
                </div>
